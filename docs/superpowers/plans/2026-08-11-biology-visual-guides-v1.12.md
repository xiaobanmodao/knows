...
执行记录（2026-08-11）：已有模拟器回归记录在 `.superpowers/sdd/2026-08-11-biology-visual-guides-v1.12/simulator-regression.md`；本次契约修复后，仍待以 iPhone 14 Pro Max 和 Nexus 5 做最终复跑。真机和发布流程未在本步骤标记为通过。
