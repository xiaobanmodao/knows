...
微信原生小程序版初中知识库项目。当前 `v1.8.0-dev.1` 在数学、英语、物理和化学知识库基础上新增生物学六单元查阅包，默认游客模式，支持：
...
数学、英语和物理容器复核按批次登记。当前 29 个数学章节、29 个数学专题、36 个数学方法模板、6 个英语专题和 6 个物理专题、6 个英语方法模板已完成容器级复核；物理方法模板仍保留在复核队列中，当前共 28 项。
...
15. 下一批按队列处理物理 28 个方法模板，优先完成章节方法模板，再完成结构化专题模板
