...
if (englishUnits.unitCount !== 42 || englishUnits.vocabularyCount !== 336 || englishUnits.grammarCount !== 84 || englishUnits.exampleCount !== 924) {
  issues.push(`规模错误：当前 ${englishUnits.unitCount} 单元、${englishUnits.vocabularyCount} 词、${englishUnits.grammarCount} 语法、${englishUnits.exampleCount} 例句，应为 42/336/84/924`);
}
...
if (exampleOwners.size !== 924) {
  issues.push(`英语例句应有 924 条，当前 ${exampleOwners.size} 条`);
}
