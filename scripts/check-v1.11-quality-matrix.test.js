...
assert.ok(defaultCommands.some((item) => item.script === 'scripts/check-physics-topic-framework-evidence.test.js'));
assert.ok(defaultCommands.some((item) => item.script === 'scripts/check-chemistry-topic-framework-evidence.test.js'));
assert.ok(defaultCommands.some((item) => item.script === 'scripts/check-biology-topic-framework-evidence.test.js'));
...
assert.ok(defaultCommands.some((item) => item.script === 'scripts/math-smartedu-edition-evidence.test.js'));
assert.ok(defaultCommands.some((item) => item.script === 'scripts/check-math-smartedu-edition-evidence.js'));
assert.ok(defaultCommands.some((item) => item.script === 'scripts/check-math-confirmed-changes.test.js'));
...
assert.ok(defaultCommands.some((item) => item.script === 'scripts/content-source-registry-url-access.test.js'));
...
assert.strictEqual(defaultCommands.length, 119, '默认质量矩阵必须保持 119 项');
